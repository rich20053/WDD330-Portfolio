...
/*
Array.prototype.displayObj = function() 
{
    var outputStr = "";
    for (var n = 0; n < this.length; n++) 
    {
        outputStr += `${n+1}. ${this[n].title} - ${this[n].author} - ${this[n].libraryID}<br>`;
        document.getElementById("postSort").innerHTML = outputStr;
    }
};*/

Array.prototype.bubbleSortObjPlayer = function() 
{
    var is_sorted = false;
    debugger;
    if (ascend) {
        while (!is_sorted) 
        {
            ...
            {
                if ((this[n].lname+this[n].fname) > (this[n+1].lname+this[n].fname)){
                    var x = this[n+1];
                    this[n+1] = this[n];
                    this[n] = x;
                    is_sorted = false;
...
Array.prototype.bubbleSortObjTeam = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
...
Array.prototype.bubbleSortObjPosition = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
        ...
        for (var n = 0; n < this.length - 1; n++) 
        {
            if (this[n].position > this[n+1].position){
                var x = this[n+1];
                this[n+1] = this[n];
                this[n] = x;
                is_sorted = false;
...
Array.prototype.bubbleSortObjPoints = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
        ...
        for (var n = 0; n < this.length - 1; n++) 
        {
            if ((this[n].points/this[n].games) < (this[n+1].points/this[n+1].games)){
                var x = this[n+1];
                this[n+1] = this[n];
                this[n] = x;
                is_sorted = false;
...
Array.prototype.bubbleSortObjRebounds = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
        ...
        for (var n = 0; n < this.length - 1; n++) 
        {
            if ((this[n].rebounds/this[n].games) < (this[n+1].rebounds/this[n+1].games)){
                var x = this[n+1];
                this[n+1] = this[n];
                this[n] = x;
                is_sorted = false;
...
Array.prototype.bubbleSortObjAssists = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
        ...
        for (var n = 0; n < this.length - 1; n++) 
        {
            if ((this[n].assists/this[n].games) < (this[n+1].assists/this[n+1].games)){
                var x = this[n+1];
                this[n+1] = this[n];
                this[n] = x;
                is_sorted = false;
...
Array.prototype.bubbleSortObjSteals = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
        ...
        for (var n = 0; n < this.length - 1; n++) 
        {
            if ((this[n].steals/this[n].games) < (this[n+1].steals/this[n+1].games)){
                var x = this[n+1];
                this[n+1] = this[n];
                this[n] = x;
                is_sorted = false;
...
Array.prototype.bubbleSortObjBlocks = function() 
{
    var is_sorted = false;
    while (!is_sorted) 
    {
        ...
        for (var n = 0; n < this.length - 1; n++) 
        {
            if ((this[n].blocks/this[n].games) < (this[n+1].blocks/this[n+1].games)){
                var x = this[n+1];
                this[n+1] = this[n];
                this[n] = x;
                is_sorted = false;
...
function sortbyPlayer(list, parentID) {
    debugger;
    list.pList.bubbleSortObjPlayer();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbyTeam(list, parentID) {
    list.pList.bubbleSortObjTeam();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbyPosition(list, parentID) {
    list.pList.bubbleSortObjPosition();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbyPoints(list, parentID) {
    list.pList.bubbleSortObjPoints();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbyRebounds(list, parentID) {
    list.pList.bubbleSortObjRebounds();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbyAssists(list, parentID) {
    list.pList.bubbleSortObjAssists();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbySteals(list, parentID) {
    list.pList.bubbleSortObjSteals();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}

function sortbyBlocks(list, parentID) {
    list.pList.bubbleSortObjBlocks();
    const parentElement = document.getElementById(parentID);
    list.displayPlayerList(parentElement);
}
...
/*    const parentElement = document.getElementById(parentID);
    //filteredList.displayPlayerList(parentElement);
    ...
    // Add players currently in the player list
    var listCount = 0;
    if (filteredList.length != 0 && filteredList[0] != undefined) {
...
/*                    if ((displayFilter == "All") ||
                ...
                filteredList.displayPlayerwStats(parentElement);
                            // Count items in displayed list
                listCount++;
                        //}
                    // Count open players
